...
function bmi(peso,altura){
    ...
    if(calcularBMI < 18.5){
        return "Bajo";
    }else if(calcularBMI >=18.5 && calcularBMI <=24.9 ){
        return "Normal";
    }else if(calcularBMI >= 25 && calcularBMI <=29.9){  
        return "Sobrepeso";
    }else{
        return "Obesidad";
    }
